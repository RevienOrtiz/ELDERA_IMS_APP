    ...
    public function run(): void
    {
        $events = [
            ...
            [
                ...
                'description' => 'Monthly distribution of social pension for qualified senior citizens.',
                'event_type' => 'pension',
                'event_date' => Carbon::now()->addDays(15),
                'start_time' => '08:00:00',
                'end_time' => '16:00:00',
                'location' => 'Municipal Hall',
                'organizer' => 'DSWD Municipal Office',
                'contact_person' => 'Ana Rodriguez',
                'contact_number' => '09123456791',
                'status' => 'upcoming',
                'max_participants' => 200,
                'current_participants' => 0,
                'requirements' => 'Valid OSCA ID, DSWD ID, and authorization letter',
                'created_by' => 1,
            ],
            [
