  ...
  <x-header title="SENIOR ID" icon="fas fa-id-card">
    ...
    <script>
        ...
        function loadAllSeniors() {
            ...
            const seniorsData = {!! json_encode(\App\Models\Senior::orderBy('last_name')->orderBy('first_name')->get(['id', 'first_name', 'last_name', 'middle_name', 'osca_id', 'barangay', 'sex', 'date_of_birth', 'birth_place', 'marital_status', 'contact_number', 'status'])) !!};
        ...
        function loadSeniorData(seniorId) {
            ...
            if (senior) {
                ...
                // Clear fields that don't exist in senior data (user needs to fill manually)
                document.getElementById('senior_annual_income').value = '';
