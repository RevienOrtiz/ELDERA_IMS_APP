...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="auth-message">WE NEED TO VERIFY YOUR IDENTITY</div>
            <div class="auth-description">Please enter the 6 digit code that we sent to your gmail account. This code will expire in 5 minutes.</div>
            ...
            <form action="{{ route('verify.code.post') }}" method="POST" class="auth-form">
                @csrf
                @if($errors->any())
    ...
    <script>
        ...
        function submitForm() {
            ...
            // Create hidden input with the full code
        ...
        function startResendCooldown() {
            resendCooldown = 60; // Reset to 1 minute
            resendButton.disabled = true;
            resendButton.textContent = `Resend Code (${resendCooldown}s)`;
        ...
        resendButton.addEventListener('click', function() {
            if (!resendButton.disabled) {
                ...
                resendForm.action = '{{ route("resend.code") }}';
                ...
                resendForm.appendChild(csrfToken);
