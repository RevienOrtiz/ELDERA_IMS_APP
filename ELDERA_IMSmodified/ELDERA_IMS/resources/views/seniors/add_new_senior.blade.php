                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-column gap-1 mt-2">
                                    <label><input type="radio" name="monthly_income" value="60000 and above"> 60000 and above</label>
                                    <label><input type="radio" name="monthly_income" value="50000 to 60000"> 50000 to 60000</label>
                                    <label><input type="radio" name="monthly_income" value="40000 to 50000"> 40000 to 50000</label>
                                    <label><input type="radio" name="monthly_income" value="30000 to 40000"> 30000 to 40000</label>
                                    <label><input type="radio" name="monthly_income" value="20000 to 30000"> 20000 to 30000</label>
                                    <label><input type="radio" name="monthly_income" value="10000 to 20000"> 10000 to 20000</label>
                                    <label><input type="radio" name="monthly_income" value="5000 to 10000"> 5000 to 10000</label>
                                    <label><input type="radio" name="monthly_income" value="below 5000"> below 5000</label>
                                    <label><input type="radio" name="monthly_income" value="None"> None</label>
                                </div>
                            </div>
