                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="monthly_income" class="form-select form-select-sm">
                                    <option value="">Select Monthly Income Range</option>
                                    <option value="60000 and above" {{ old('monthly_income', $senior->monthly_income ?? '') == '60000 and above' ? 'selected' : '' }}>60000 and above</option>
                                    <option value="50000 to 60000" {{ old('monthly_income', $senior->monthly_income ?? '') == '50000 to 60000' ? 'selected' : '' }}>50000 to 60000</option>
                                    <option value="40000 to 50000" {{ old('monthly_income', $senior->monthly_income ?? '') == '40000 to 50000' ? 'selected' : '' }}>40000 to 50000</option>
                                    <option value="30000 to 40000" {{ old('monthly_income', $senior->monthly_income ?? '') == '30000 to 40000' ? 'selected' : '' }}>30000 to 40000</option>
                                    <option value="20000 to 30000" {{ old('monthly_income', $senior->monthly_income ?? '') == '20000 to 30000' ? 'selected' : '' }}>20000 to 30000</option>
                                    <option value="10000 to 20000" {{ old('monthly_income', $senior->monthly_income ?? '') == '10000 to 20000' ? 'selected' : '' }}>10000 to 20000</option>
                                    <option value="5000 to 10000" {{ old('monthly_income', $senior->monthly_income ?? '') == '5000 to 10000' ? 'selected' : '' }}>5000 to 10000</option>
                                    <option value="below 5000" {{ old('monthly_income', $senior->monthly_income ?? '') == 'below 5000' ? 'selected' : '' }}>below 5000</option>
                                    <option value="None" {{ old('monthly_income', $senior->monthly_income ?? '') == 'None' ? 'selected' : '' }}>None</option>
                                </select>
                                <small class="form-text text-muted">Select the appropriate monthly income range</small>
                            </div>
                        </div>
                    </div>
                </div>
