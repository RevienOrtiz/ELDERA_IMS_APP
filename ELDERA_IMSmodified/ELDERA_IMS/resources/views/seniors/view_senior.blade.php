                  ...
                  <div class="form-section">
                      ...
                      <div class="d-flex justify-content-between align-items-center mb-3">
                          ...
                          <div class="button-group">
                              ...
                              <button onclick="confirmEdit('{{ $senior->id }}', '{{ $senior->first_name }} {{ $senior->last_name }}')" class="action-btn edit-btn">
                                  <i class="fas fa-edit"></i> Edit
                              </button>
                              <button onclick="generatePDF()" class="action-btn pdf-btn">
                                  <i class="fas fa-file-pdf"></i> Generate PDF
                              </button>
                              <button onclick="confirmDelete('{{ $senior->id }}', '{{ $senior->first_name }} {{ $senior->last_name }}')" class="action-btn delete-btn">
