<x-sidebar>
    <x-header title="VIEW SENIOR ID APPLICATION" icon="fas fa-id-card">
      <div class="main">
          <div class="form">
              <div class="form-content">
                  <div class="form-section">
                      ...
                      <div style="background-color: #e31575; color: white; padding: 10px; font-weight: bold; margin-bottom: 20px;">
                          SENIOR ID APPLICATION - SENIOR CITIZEN ID
                      </div>
                      ...
                      <div class="row">
                              ...
                              <div class="info-section-clean mb-4">
                                  ...
                                  <div class="info-content">
                                      <div class="info-row">
                                          ...
                                          <span class="info-value">{{ $application->senior->last_name }}, {{ $application->senior->first_name }} {{ $application->senior->middle_name ?? '' }}</span>
                                      </div>
                                      <div class="info-row">
                                      ...
                                      <div class="info-row">
                                          ...
                                          <span class="info-value">{{ ucfirst($application->seniorIdApplication->address ?? $application->senior->barangay ?? 'N/A') }}</span>
                                      </div>
                                      <div class="info-row">
                                          <span class="info-label">Gender:</span>
                                          <span class="info-value">{{ ucfirst($application->senior->sex ?? 'N/A') }}</span>
                                      </div>
                                      <div class="info-row">
                                      ...
                                      <div class="info-row">
                                          ...
                                          <span class="info-value">{{ $application->seniorIdApplication->occupation ?? $application->senior->employment ?? 'N/A' }}</span>
                                      </div>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="col-md-6">
                              <div class="info-section-clean mb-4">
                                  <h6 class="section-title">ID APPLICATION DETAILS</h6>
                                  <div class="info-content">
                                      <div class="info-row">
                                      ...
                                      <div class="info-row">
                                          ...
                                          <span class="info-value">{{ $application->created_at ? $application->created_at->format('F j, Y') : 'N/A' }}</span>
                                      </div>
                                      <div class="info-row">
                                          <span class="info-label">Status:</span>
                                          <span class="info-value">{{ $application->status ?? 'Pending' }}</span>
                                      </div>
                                      <div class="info-row">
                                          <span class="info-label">ID Type:</span>
                                          <span class="info-value">Senior Citizen ID</span>
                                      </div>
                                      <div class="info-row">
                                          <span class="info-label">Issue Date:</span>
                                          <span class="info-value">{{ $application->seniorIdApplication->issue_date ?? 'N/A' }}</span>
                                      </div>
                                      <div class="info-row">
                                          <span class="info-label">Expiry Date:</span>
                                          <span class="info-value">{{ $application->seniorIdApplication->expiry_date ?? 'N/A' }}</span>
                                      </div>
                                      <div class="info-row">
                                          <span class="info-label">Issuing Authority:</span>
                                          <span class="info-value">{{ $application->seniorIdApplication->issuing_authority ?? 'OSCA' }}</span>
                                      </div>
                                  </div>
                              </div>
                          </div>
                              ...
                              <div class="info-section-clean mb-4">
                                  ...
                                  <div class="info-content">
                                      <div class="info-row">
                                          ...
                                          <span class="info-value">{{ $application->seniorIdApplication->civil_status ?? 'N/A' }}</span>
                                      </div>
                                      <div class="info-row">
                                          <span class="info-label">Annual Income:</span>
                                          <span class="info-value">{{ $application->seniorIdApplication->annual_income ?? 'N/A' }}</span>
                                      </div>
                                      <div class="info-row">
                                          <span class="info-label">Pension Source:</span>
                                          <span class="info-value">{{ $application->seniorIdApplication->pension_source ?? 'N/A' }}</span>
                                      </div>
                                      <div class="info-row">
                                          <span class="info-label">C.T.C. Number:</span>
                                          <span class="info-value">{{ $application->seniorIdApplication->ctc_number ?? 'N/A' }}</span>
                                      </div>
                                  </div>
                              </div>
                          </div>
                              ...
                              <div class="info-section-clean mb-4">
                                  ...
                                  <div class="info-content">
                                      <div class="info-row">
                                          ...
                                          <span class="info-value">{{ $application->seniorIdApplication->date_of_application ? date('M d, Y', strtotime($application->seniorIdApplication->date_of_application)) : 'N/A' }}</span>
                                      </div>
                                      <div class="info-row">
                                          <span class="info-label">Place of Issuance:</span>
                                          <span class="info-value">{{ $application->seniorIdApplication->place_of_issuance ?? 'Municipality of Lingayen, Pangasinan' }}</span>
                                      </div>
                                      <div class="info-row">
                                          <span class="info-label">Date Issued:</span>
                                          <span class="info-value">{{ $application->seniorIdApplication->date_of_issued ? date('M d, Y', strtotime($application->seniorIdApplication->date_of_issued)) : 'N/A' }}</span>
                                      </div>
                                      <div class="info-row">
                                          <span class="info-label">Date Received:</span>
                                          <span class="info-value">{{ $application->seniorIdApplication->date_of_received ? date('M d, Y', strtotime($application->seniorIdApplication->date_of_received)) : 'N/A' }}</span>
                                      </div>
                                  </div>
                              </div>
                          </div>
