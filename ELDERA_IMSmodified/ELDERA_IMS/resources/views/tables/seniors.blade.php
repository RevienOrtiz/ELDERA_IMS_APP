<x-sidebar>
    <x-header title="Senior Citizen" icon="fas fa-table">
        ...
        <div class="main">
            ...
            @if(!isset($includeStylesOnly) || !$includeStylesOnly)
            <!-- All Seniors Table -->
            <div class="table-container" id="all-seniors-table">
                        ...
                        <tr data-senior-id="{{ $senior->id }}">
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('view_senior', $senior->id) }}" class="btn btn-info" title="View">
                                        <i class="fas fa-eye"></i> View
                                    </a>
                                    <a href="{{ route('edit_senior', $senior->id) }}" class="btn btn-warning" title="Edit">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <button type="button" class="btn btn-danger" title="Delete" onclick="showDeleteModal('{{ $senior->id }}', '{{ $senior->first_name }} {{ $senior->last_name }}')">
                ...
                <table class="records-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="{{ route('seniors.id-application.view', $application->id) }}" class="btn btn-info" title="View">
                                        <i class="fas fa-eye"></i> View
                                    </a>
                                    <a href="{{ route('seniors.id-application.edit', $application->id) }}" class="btn btn-warning" title="Edit">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <button type="button" class="btn btn-danger" title="Delete" onclick="showDeleteModal('{{ $application->id }}', '{{ $application->senior ? $application->senior->first_name . ' ' . $application->senior->last_name : 'N/A' }}', 'id')">
                                        <i class="fas fa-trash"></i> Delete
                                    </button>
                                </div>
                            </td>
